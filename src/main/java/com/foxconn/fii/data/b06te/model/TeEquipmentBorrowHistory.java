...
@Data
@Entity
@Table(name = "TE_EQUIPMENT_BORROW_HISTORY")
public class TeEquipmentBorrowHistory {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TeEquipmentBorrowHistory_SEQ")
    @SequenceGenerator(sequenceName = "TE_EQUIPMENT_BORROW_HISTORY_S", allocationSize = 1, name = "TeEquipmentBorrowHistory_SEQ")
    private long id;
    ...
    public TeEquipmentBorrowHistory(){}

    public TeEquipmentBorrowHistory(Map<String, Object> data) throws ParseException {
