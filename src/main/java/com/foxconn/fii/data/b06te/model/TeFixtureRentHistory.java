...
@Data
@Entity
@Table(name = "TE_FIXTURE_RENT_HISTORY")
public class TeFixtureRentHistory {

    @Id
    @Column(name = "ID")
    @GeneratedValue(strategy = GenerationType.SEQUENCE, generator = "TeFixtureRentHistory_SEQ")
    @SequenceGenerator(sequenceName = "TE_FIXTURE_RENT_HISTORY_SEQ", allocationSize = 1, name = "TeFixtureRentHistory_SEQ")
    private long id;
    ...
    public TeFixtureRentHistory(){}

    public TeFixtureRentHistory(Map<String, Object> data) throws ParseException {
