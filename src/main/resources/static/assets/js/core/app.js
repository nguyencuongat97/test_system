...
$(function() {
    ...
    function containerHeight() {
        ...
        $('.page-container').attr('style', 'background-color: #272727; min-height:' + availableHeight + 'px');
        $('.fii-sidebar-menu').attr('style', 'background-color: #272727; min-height:' + availableHeight + 'px');
    }
