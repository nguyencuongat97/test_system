...
function moveToDetailPage(context) {
    window.open("http://10.224.81.70:8888/station-detail" + "?factory=" + context.dataset.factory + "&modelName=" + context.dataset.modelName + "&groupName=" + context.dataset.groupName + "&stationName=" + context.dataset.stationName + "&timeSpan=" + dataset.timeSpan);
}
