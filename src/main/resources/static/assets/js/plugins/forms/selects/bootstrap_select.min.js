            ...
            clickListener: function() {
                ...
                this.$element.on("shown.bs.select", function() {
                    if (b.options.liveSearch || b.multiple) {
                        ...
                        b.$menuInner.find(".active a").focus()
                }),
                            ...
                            l !== !1 || m !== !1) {
                                ...
                                if (l && n || m && o)
                                    if (l && 1 == l)
                                        ...
                                        b.$menuInner.find('[data-optgroup="' + p + '"]').removeClass("active"),
                                        b.setSelected(e, !0)
                                    } else {
            ...
            liveSearchListener: function() {
                ...
                this.$button.on("click.dropdown.data-api touchstart.dropdown.data-api", function() {
                    if (!d.options.focusOff) {
                        ...
                        d.multiple || d.$menuInner.find(".active").addClass("active"),
                        setTimeout(function() {
                            d.$searchbox.focus()
                        }, 10)
                    }
...
//                    a(this).focus()
            ...
            changeAll: function(b) {
                ...
                this.findLis();
                for (var c = this.$element.find("option"), d = this.$lis.not(".divider, .dropdown-header, .disabled, .hidden").toggleClass("active", b), e = d.length, f = [], g = 0; e > g; g++) {
