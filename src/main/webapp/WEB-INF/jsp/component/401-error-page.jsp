...
<div id="wrapper">
    <div class="container">
        ...
        <div class="info">
            <h2>Unauthorized</h2>
            <p>Your authorization failed.<br>Pleasa try refreshing the page and fill in the correct login details.</p>
...
.number .one{
    ...
    margin-left: -113px;
    display: inline-block;
    background-image: url("/assets/images/custom/image404/one.png");
    background-repeat: no-repeat;
    background-size: 100%;
    z-index: 19;
    position: relative;
