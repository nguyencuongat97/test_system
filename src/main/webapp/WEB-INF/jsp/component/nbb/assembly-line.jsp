...
<%@ include file="modal/modal-setup-model-nbb.jsp" %>
    ...
    <script>
        ...
        function getParameter() {
            ...
            if (customer == undefined || customer == "") {
                dataset = JSON.parse(window.localStorage.getItem('dataset'));
        ...
        $('.dropdown-select-customer').on('click', '.select-customer li a', function() {
            ...
            loadSelectMO();
            dataset.modelName = "";
            $('.dropdown-select-modelName').find('.dropdown-toggle').html('Select ModelName <span class="caret"></span>');
            loadSelectModel();
