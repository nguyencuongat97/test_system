...
<div class="panel panel-re panel-flat row" style="background-color: #272727; text-align: center; color: #ccc; margin-bottom: 0px;">
    <div class="col-lg-12">
        <div class="panel panel-overview" id="header">
            <b><span id="titlePage" class="disableSelect"></span><span class="text-uppercase"> ${factory}</span><span> LACK DATA SFIS AND TEST DATA</span></b>
        </div>
...
<script>
    ...
    if (dataset == null || dataset == undefined || dataset.path != "nbb-missing-data-sfis") {
        dataset = {
            countryCode: "V71",
            path: "nbb-missing-data-sfis"
        }
    ...
    function loadData() {
        ...
        $.ajax({
            type: 'POST',
            url: 'http://10.224.81.103:2017/api/values/nbbguobieshao',
    ...
    $("#btnExport").click(function() {
        ...
        if (isIE) {
            ...
            $(this).attr('download', 'Lack Data SFIS And Test Data.xls')
