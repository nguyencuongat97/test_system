...
<script>
    ...
    function loadData() {
        $.ajax({
            type: 'GET',
            url: '/api/test/' + dataset.factory + '/group/output',
            data: {
            ...
            success: function(data) {
                ...
                for (i in dataStage) {
                    if (dataStage[i] != null && dataStage[i] != undefined) {
                        ...
                        $("." + i).first().append("<td rowspan=" + rowS1 + " class='" + i + "1'>" + i + "</td>");
                    }
                }
                var childS1 = 1;
                for (i in dataStage) {
                    if (dataStage[i] != null && dataStage[i] != undefined) {
                        for (j in dataStage[i]) {
                            $("." + i + ":nth-child(" + childS1 + ")").append("<td rowspan=" + 4 + " class='" + i + "2'>" + j + "</td>");
                            childS1 += 4;
                        }
                    }
                }
                ...
                for (i in dataStage) {
                    if (dataStage[i] != null && dataStage[i] != undefined) {
                        for (j in dataStage[i]) {
                            $("." + i + j + "Day:nth-child(" + childS2 + ")").append("<td rowspan=" + 2 + " class='" + i + "3'>Day</td>");
                            childS2 += 2;
                            $("." + i + j + "Night:nth-child(" + childS2 + ")").append("<td rowspan=" + 2 + " class='nShift " + i + "3'>Night</td>");
                            childS2 += 2;
                        }
                    }
                }
                for (i in dataStage) {
                    if (dataStage[i] != null && dataStage[i] != undefined) {
                        for (j in dataStage[i]) {
                            $("." + i + j + "Day.in").append("<td class='" + i + "4'>Input</td>");
                            $("." + i + j + "Day.out").append("<td class='" + i + "4'>Output</td>");
                            $("." + i + j + "Night.in").append("<td class='nShift " + i + "4'>Input</td>");
                            $("." + i + j + "Night.out").append("<td class='nShift " + i + "4'>Output</td>");
                        }
                    }
                }
