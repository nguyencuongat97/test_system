...
<script src="/assets/js/custom/cpk.js"></script>
<script>
    // init
    // $body = $("body");
    // $(document).on({
    ...
    $(document).ready(function() {
        // var cpkTS = getTimeSpan();
        // $('input[name="timeSpan"]').data('daterangepicker').setStartDate(cpkTS.startDate);
        // $('input[name="timeSpan"]').data('daterangepicker').setEndDate(cpkTS.endDate);
        getTimeNow();
