<div class="row" style="padding: 10px; background-color: #272727; text-align: center; color: #ccc">
    ...
    <!--
        <div style="min-height: 300px; border: solid 1px rgba(0, 0, 0, 0.2); padding: 10px; margin-bottom: 10px; text-align: left;">
            <input name="models" type="text" data-role="tagsinput">
        </div>
        <div>
            <button class="btn" name="save" onclick="save();" disabled><i class="fa fa-check"></i> SAVE</button>
            <button class="btn" name="cancel" onclick="cancel();" disabled><i class="fa fa-close"></i> CANCEL</button>
        </div>
    -->
