...
<div class="panel panel-re panel-flat row" style="background-color: #272727; text-align: center; color: #ccc; margin-bottom: 0px;">
    <div class="col-lg-12">
        ...
        <div class="row no-margin no-padding">
            ...
            <div class="col-md-4 no-padding">
                ...
                <div class='col-xs-5 selectModel' style="margin-bottom: 5px;">
                    ...
                    <select class="form-control bootstrap-select" name="modelName" data-live-search="true" data-focus="false"></select>
                </div>
            </div>
        ...
        <div class="row no-margin">
            <div class="col-sm-12 table-responsive pre-scrollable no-padding" style="max-height: calc(100vh - 175px);color: #ccc;">
                <table id="tblDetail" class="table table-xxs table-bordered table-sticky">
                </table>
            </div>
        </div>
    </div>
...
<script>
    ...
    function loadData() {
        ...
        $.ajax({
            type: "GET",
            url: "/api/test/group/outputOfDate",
            data: {
                factory: dataset.factory,
                shiftType: dataset.shiftType,
                workDate: dataset.workDate,
