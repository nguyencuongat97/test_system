        ...
        <div class="tab-error-code">
            ...
            <div class="tab-content">
                ...
                <div id="trouble" class="tab-pane active" style="margin:0 auto; font-size: 13px;">
                    ...
                    <div id="chart-top3-station-issue" style="height: 300px; border: solid 1px rgba(0, 0, 0, 0.2);"></div>
                </div>
                <!--Tab history-->
...
function loadChartStationByError() {
    ...
    $.ajax({
        type: 'GET',
        url: '/api/test/station/weekly/top3',
        data: {
            factory: dataset.factory,
            modelName: dataset.modelName,
            groupName: dataset.groupName,
        ...
        success: function(data){
            ...
            for(i in data){
                ...
                categories[i] = data[i].stationName;
                dataChart[i] = {name: data[i].stationName, y: data[i].retestRate, color: color}
            }

            Highcharts.chart('chart-top3-station-issue',{
                chart: {
                    type: 'column'
                },
                title: {
                    text: 'TOP 3 TESTER ISSUE'
                },
                subtitle: {
                    text: ''
                },
